    ...
    <>
      <ul className={`${menuClicked ? 'hidden' : ''} absolute bg-white top-0 right-0 w-[256px] p-[24px] h-full text-[18px] sm:flex sm:items-center sm:w-[438px] sm:place-content-around sm:p-0 sm:h-auto sm:relative sm:text-[16px]`}>
        ...
        <li className='mb-8 sm:mb-0'>
          <a className='hover:text-Pinky sm:text-4' href="#">Home</a>
        </li>
        <li className='mb-8 sm:mb-0'>
          <a className='hover:text-Pinky' href="#">New</a>
        </li>
        <li className='mb-8 sm:mb-0'>
          <a className='hover:text-Pinky' href="#">Popular</a>
        </li>
        <li className='mb-8 sm:mb-0'>
          <a className='hover:text-Pinky' href="#">Trending</a>
        </li>
        <li className='mb-8 sm:mb-0'>
          <a className='hover:text-Pinky' href="#">Categories</a>
        </li>
      </ul>
